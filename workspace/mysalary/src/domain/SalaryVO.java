...
public class SalaryVO {
	...
	public String toString() {
		return SalaryDAO.insertComma(salary) + "만원   " + SalaryDAO.insertComma(netPay) + "   "
				+ SalaryDAO.insertComma(taxDeductionAmount) + "   " + SalaryDAO.insertComma(pension) + "   "
				+ SalaryDAO.insertComma(healthInsurance) + "   " + SalaryDAO.insertComma(longTermCarePay) + "   "
				+ SalaryDAO.insertComma(employmentInsurance) + "   " + SalaryDAO.insertComma(incomeTax) + "   "
				+ SalaryDAO.insertComma(localTax);
	}
